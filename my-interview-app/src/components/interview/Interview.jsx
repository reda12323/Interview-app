...
const Interview = () => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:5000/interview/${sessionId}`)
  ...
  const handleEndInterview = () => {
    ...
    subtitleLog.forEach(entry => {
      if (entry.who === 'AI') {
        ...
        qaPairs.push({ question: currentQuestion, answer: entry.text });
        currentQuestion = null;
      }
    });

    if (qaPairs.length === 0) {
      alert("Not enough answers to evaluate.");
      return;
    }
    ...
    axios.post('http://localhost:5000/evaluate-answers', {
      jobDescription,
      answers: qaPairs
    })
      .then(res => {
        ...
        <>
          ...
          <div className="interview-main">
            ...
            <div className="controls">
              ...
              <button onClick={handleEndInterview} className="control-btn end-btn">
                ⏹️ End Interview
              </button>
